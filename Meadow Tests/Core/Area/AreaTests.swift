...
class AreaTests: XCTestCase {
    ...
    func testAreaNodeAddition() {
        ...
        let n0 = scene.world.areas.add(node: Coordinate(x: 13, y: 0, z: 37))
        let n1 = scene.world.areas.add(node: coordinate + Coordinate.left)
        let n2 = scene.world.areas.add(node: coordinate)
    ...
    func testAreaNodeNeighbourAddition() {

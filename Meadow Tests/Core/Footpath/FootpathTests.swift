...
class FootpathTests: XCTestCase {
    ...
    func testFootpathNodeAddition() {
        ...
        let n0 = meadow.footpaths.add(node: Coordinate(x: 13, y: 0, z: 37))
        let n1 = meadow.footpaths.add(node: coordinate + Coordinate.left)
        let n2 = meadow.footpaths.add(node: coordinate)

...
class TerrainLayerTests: XCTestCase {
    ...
    func testTerrainLayerPolygons() {
        ...
        XCTAssertEqual(l0?.polyhedron.upperPolytope.vertices[0].z, 36.5)
        ...
        XCTAssertEqual(l0?.polyhedron.upperPolytope.vertices[1].z, 36.5)
        ...
        XCTAssertEqual(l0?.polyhedron.upperPolytope.vertices[2].z, 37.5)
        ...
        XCTAssertEqual(l0?.polyhedron.upperPolytope.vertices[3].z, 37.5)
        ...
        XCTAssertEqual(l0?.polyhedron.lowerPolytope.vertices[0].z, 36.5)
        ...
        XCTAssertEqual(l0?.polyhedron.lowerPolytope.vertices[1].z, 36.5)
        ...
        XCTAssertEqual(l0?.polyhedron.lowerPolytope.vertices[2].z, 37.5)
        ...
        XCTAssertEqual(l0?.polyhedron.lowerPolytope.vertices[3].z, 37.5)
        ...
        XCTAssertEqual(l1?.polyhedron.upperPolytope.vertices[0].z, 36.5)
        ...
        XCTAssertEqual(l1?.polyhedron.upperPolytope.vertices[1].z, 36.5)
        ...
        XCTAssertEqual(l1?.polyhedron.upperPolytope.vertices[2].z, 37.5)
        ...
        XCTAssertEqual(l1?.polyhedron.upperPolytope.vertices[3].z, 37.5)
        ...
        XCTAssertEqual(l1?.polyhedron.lowerPolytope.vertices[0].z, 36.5)
        ...
        XCTAssertEqual(l1?.polyhedron.lowerPolytope.vertices[1].z, 36.5)
        ...
        XCTAssertEqual(l1?.polyhedron.lowerPolytope.vertices[2].z, 37.5)
        ...
        XCTAssertEqual(l1?.polyhedron.lowerPolytope.vertices[3].z, 37.5)
        ...
        XCTAssertEqual(l2?.polyhedron.upperPolytope.vertices[0].z, 36.5)
        ...
        XCTAssertEqual(l2?.polyhedron.upperPolytope.vertices[1].z, 36.5)
        ...
        XCTAssertEqual(l2?.polyhedron.upperPolytope.vertices[2].z, 37.5)
        ...
        XCTAssertEqual(l2?.polyhedron.upperPolytope.vertices[3].z, 37.5)
        ...
        XCTAssertEqual(l2?.polyhedron.lowerPolytope.vertices[0].z, 36.5)
        ...
        XCTAssertEqual(l2?.polyhedron.lowerPolytope.vertices[1].z, 36.5)
        ...
        XCTAssertEqual(l2?.polyhedron.lowerPolytope.vertices[2].z, 37.5)
        ...
        XCTAssertEqual(l2?.polyhedron.lowerPolytope.vertices[3].z, 37.5)
    ...
    func testTerrainLayerSmoothTerraforming() {
        ...
        let n0 = meadow.terrain.add(node: coordinate)
        let n1 = meadow.terrain.add(node: coordinate + Coordinate.Forward)
        let n2 = meadow.terrain.add(node: coordinate + Coordinate.Left)
        let n3 = meadow.terrain.add(node: coordinate + Coordinate.Forward + Coordinate.Left)

...
public class FootpathTile: Tile {
    ...
    public var tileType: FootpathTileType = .stone {
    ...
    var tilesetTile: FootpathTilesetTile? {
    ...
    override func collapse() {
        ...
        guard let tilemap = scene?.world.tilemaps.footpath, tilesetTile == nil else { return }
